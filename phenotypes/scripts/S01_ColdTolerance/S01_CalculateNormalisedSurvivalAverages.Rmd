...
cold_survival_normalised <- cold_survival |> 
  ...
  reframe(
    ...
    survical_drop = per_drop,
    survical_drop_normalised = per_drop / control_ave
  ) |> 
  dplyr::distinct()
```
...
cold_survival_normalised_averages <- cold_survival_normalised |> 
  ...
  reframe(
    ...
    date = date,
    control_ave = control_ave,
    survical_drop_sd = sd(survical_drop, na.rm = TRUE),
    survical_drop = mean(survical_drop, na.rm = TRUE),
    survical_drop_normalised_sd = sd(survical_drop_normalised, na.rm = TRUE),
    survical_drop_normalised = mean(survical_drop_normalised, na.rm = TRUE), 
  ) |> 
  dplyr::distinct()
```
