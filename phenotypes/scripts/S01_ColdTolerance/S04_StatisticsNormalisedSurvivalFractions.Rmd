...
path_to_results <- here::here("phenotypes/results/R01_ColdTolerance/R04_StatisticsNormalisedSurvivalFractions")
```
...
```{r save-normalised-pairwise-comparisons-plot}
ggsave(
  filename = here(path_to_results, "F01_NormalisedSurvivalFractionsVsStartingTemperature.pdf"), 
  plot = last_plot(), 
  bg = "transparent", 
  width = 10, 
  height = 7
